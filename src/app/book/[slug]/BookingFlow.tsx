            ...
            <div className={s.bookingCard}>
                ...
                <div className={s.sidebar}>
                    {step === 'details' ? (
                        ...
                        <button type="button" className={s.backBtn} onClick={() => window.location.href = '/book'}>
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M15 18l-6-6 6-6" /></svg>
                        </button>
                    )}
                    <Image src={p.avatar_url || '/images/karim.jpg'} alt={p.name} width={120} height={120} className={s.sidebarPhoto} />
